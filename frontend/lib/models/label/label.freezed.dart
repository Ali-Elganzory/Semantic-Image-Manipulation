...
abstract class $LabelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, int index, String name});
}
...
class _$_Label implements _Label {
  const _$_Label(
      {this.id = Empty.INT, required this.index, required this.name});
  ...
  @override
  String toString() {
    return 'Label(id: $id, index: $index, name: $name)';
  }
...
abstract class _Label implements Label {
  const factory _Label(
      ...
      required final String name}) = _$_Label;
