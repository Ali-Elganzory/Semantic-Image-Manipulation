...
mixin _$TabsState {
  ...
  Tab get selectedTab => throw _privateConstructorUsedError;
...
abstract class $TabsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Tab> tabs, Tab selectedTab});

  $TabCopyWith<$Res> get selectedTab;
}
...
class _$TabsStateCopyWithImpl<$Res, $Val extends TabsState>
  ...
  @pragma('vm:prefer-inline')
  $TabCopyWith<$Res> get selectedTab {
    return $TabCopyWith<$Res>(_value.selectedTab, (value) {
...
class _$_TabsState extends _TabsState {
  const _$_TabsState({required final List<Tab> tabs, required this.selectedTab})
      : _tabs = tabs,
        super._();
  ...
  @override
  String toString() {
    return 'TabsState(tabs: $tabs, selectedTab: $selectedTab)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_tabs), selectedTab);
...
abstract class _TabsState extends TabsState {
  const factory _TabsState(
      ...
      required final Tab selectedTab}) = _$_TabsState;
